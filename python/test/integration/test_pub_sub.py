...
def test_python_pub_sub():
    ...
    # check logs
    assert "Sent Msg" in pub.stdout.read(), "Publisher did not send correct data."
    assert "All msg received.\n" in sub.stdout.read(), "Subscriber did not receive correct data."
